...
const classroomVideos = [
  {
    videoId: 'u_GDY5gnBUM',
    title: 'Board Game',
    description: 'Children race along a board, naming letter sounds — combining movement and repetition.',
  },
  {
    videoId: 'Q3hzmqEFO6M',
    title: 'Snap',
    description: 'A fast-paced card game where learners race to match letter sounds.',
  },
  {
    videoId: 'A82dce50QFo',
    title: 'Memory Game',
    description: 'Pairs of letter-sound cards laid face down — children flip and match.',
  },
];
