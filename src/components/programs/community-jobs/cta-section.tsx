...
export default function CtaSection() {
  return (
    <section className="bg-[#1D4ED8] text-white py-20 md:py-28">
      <div className="container mx-auto px-4 text-center">
        ...
        <FadeUp delay={0.1}>
          <p className="text-white/85 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Your donation hires and trains a young person from the community to teach in
            their own school, and we&apos;ll show you the data to prove it&apos;s working.
          </p>
        </FadeUp>
        <FadeUp delay={0.2}>
          <div className="flex flex-wrap justify-center items-center gap-4 mb-12">
            <a
              href="/donate"
              className="bg-white text-[#1D4ED8] hover:bg-white/90 px-10 py-4 rounded-md font-semibold text-lg transition-colors"
            >
              Donate
            </a>
            <a
