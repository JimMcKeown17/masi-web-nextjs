      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            ...
            <span className="text-blue-700">Department of Education</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {benefits.map((benefit) => {
            ...
            return (
              <div
                key={benefit.title}
                className="p-6 rounded-2xl bg-gray-50 border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all duration-200"
              >
                <div className="w-11 h-11 rounded-xl bg-blue-700 text-white flex items-center justify-center mb-4">
        ...
        {/* Dark banner */}
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-blue-700 to-blue-900 p-8 md:p-12">
          <div
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex gap-6 flex-shrink-0">
              ...
              <div className="text-center">
                <div className="text-4xl font-bold text-yellow-400">EC DoE</div>
