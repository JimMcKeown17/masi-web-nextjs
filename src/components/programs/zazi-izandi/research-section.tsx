...
export default function ZaziResearchSection() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-yellow-400 rounded-lg z-0" />
            <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl">
              <Image
                src="/zazi-izandi/images/ZZ Research Photo.png"
            ...
            {/* Bottom-right accent */}
            <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-blue-700/10 rounded-lg z-0" />
            ...
            <div className="absolute bottom-6 left-6 z-20 bg-white rounded-lg shadow-lg p-4 flex items-center gap-3 max-w-xs">
              <div className="bg-blue-700 rounded-md p-2 shrink-0">
          ...
          <div>
            ...
            <ul className="space-y-4 mb-10">
              {findings.map((finding, i) => (
                <li key={i} className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 mt-0.5 shrink-0 text-blue-700" />
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              >
                <a href="/zazi-izandi/downloads/Zazi iZandi Research Advisory Note.pdf" target="_blank" rel="noopener noreferrer">
                  Read the Brief
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-gray-300 text-gray-800 hover:border-blue-700 hover:text-blue-700 font-semibold"
              >
                <a
