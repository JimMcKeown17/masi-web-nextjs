        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-lg text-gray-700">
              <p>
                What would happen if you flooded an impoverished community with university graduates?
              </p>
              <p className="font-bold text-xl bg-gradient-to-r from-blue-600 to-rose-600 bg-clip-text text-transparent">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                ...
                src="https://www.youtube.com/embed/Yg3elIFqDS8?si=dwl9Q6asnIeaBHr-"
