...
export default function AnnualReportSection() {
    return (
        ...
        <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-white text-center px-4 z-10">
          ...
          <a href={getAssetUrl('reports/Masinyusane Annual Report 2024 (R).pdf')} target="_blank" rel="noopener noreferrer" className="border-2 border-white text-white px-8 py-3 rounded-md hover:bg-white hover:text-black transition text-lg">Read the Annual Report</a>
        </div>
      </section>
